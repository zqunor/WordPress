	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				?>
				<input class="hybridextend-customize-control-icon" value="<?php echo esc_attr( $this->value() ) ?>" <?php $this->link(); ?> type="hidden"/>
				<div class="hybridextend-customize-control-icon-picked hybridextend-flypanel-button" data-flypaneltype="icon"><i class="fa <?php echo esc_attr( $this->value() ) ?>"></i><span><?php _e( 'Select Icon', 'hybrid-core' ) ?></span></div>
				<div class="hybridextend-customize-control-icon-remove"><i class="fa fa-ban"></i><span><?php _e( 'Remove Icon', 'hybrid-core' ) ?></span></div>
